package br.com.sicredi.desafio.infrastructure.config.testcontainers;

import br.com.sicredi.desafio.DesafioApiApplication;
...
@SpringBootTest(classes = DesafioApiApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
